        ...
        <div className="content-2-4">
            <div className="container lg:px-32 md:px-8 sm:px-12 px-5 pt-20 pb-12 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    <h1 className="text-4xl font-semibold title-font mb-2.5 text-white">
                        3 Keys Benefit
                    </h1>
                    <h2 className="text-base font-light title-font mx-12 lg:w-full md:w-full sm:w-3/6 sm:mx-auto text-medium-white">
                        You can easily manage your business with a powerful
                        tools
                    </h2>
                </div>
                        ...
                        <div className="flex rounded-lg h-full lg:pt-8 lg:pb-8 md:pt-8 md:pb-8 pt-12 pb-12 flex-col">
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="leading-relaxed text-base text-center tracking-wide text-gray">
                                    ...
                                    <br /> can check data in real time
                                </p>
                            </div>
                        </div>
                    </div>
